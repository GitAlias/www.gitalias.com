<svelte:head>
    <title>git add-ignored | GitAlias.com</title>
</svelte:head>

<div class="prose">

<h1 id="git-add-ignored">git add-ignored</h1>
<h2 id="add-ignored-files">Add ignored files</h2>
<p>Git alias:</p>
<pre class="git"><code>add-ignored = !&quot;f() &lbrace; git ls-files --ignored | sort -u ; &rbrace;; git add `grave;f`grave;&quot;</code></pre>
<p>Example:</p>
<pre class="shell"><code>git add-ignored</code></pre>
<p>Compare:</p>
<ul>
...
<li><a href="../git-add-ignored">git add-ignored</a> (this alias)</li>
