<svelte:head>
    <title>git edit-modified | GitAlias.com</title>
</svelte:head>

<div class="prose">

<h1 id="git-edit-modified">git edit-modified</h1>
<h2 id="edit-modified-files">Edit modified files</h2>
<p>Git alias:</p>
<pre class="git"><code>edit-modified = !&quot;f() &lbrace; git ls-files --modified | sort -u ; &rbrace;; `grave;git var GIT_EDITOR`grave; `grave;f`grave;&quot;</code></pre>
<p>Example:</p>
<pre class="shell"><code>git edit-modified</code></pre>
<p>Compare:</p>
<ul>
...
<li><a href="../git-add-stage">git add-stage</a></li>
