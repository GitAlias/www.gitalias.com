<svelte:head>
    <title>git edit-ignored | GitAlias.com</title>
</svelte:head>

<div class="prose">

<h1 id="git-edit-ignored">git edit-ignored</h1>
<h2 id="edit-ignored-files">Edit ignored files</h2>
<p>Git alias:</p>
<pre class="git"><code>edit-ignored = !&quot;f() &lbrace; git ls-files --ignored | sort -u ; &rbrace;; `grave;git var GIT_EDITOR`grave; `grave;f`grave;&quot;</code></pre>
<p>Example:</p>
<pre class="shell"><code>git edit-ignored</code></pre>
<p>Compare:</p>
<ul>
...
<li><a href="../git-edit-ignored">git edit-ignored</a> (this alias)</li>
