<svelte:head>
    <title>git add-others | GitAlias.com</title>
</svelte:head>

<div class="prose">

<h1 id="git-add-others">git add-others</h1>
<h2 id="add-other-files">Add other files</h2>
<p>Git alias:</p>
<pre class="git"><code>add-others = !&quot;f() &lbrace; git ls-files --others | sort -u ; &rbrace;; git add `grave;f`grave;&quot;</code></pre>
<p>Example:</p>
<pre class="shell"><code>git add-others</code></pre>
<p>Compare:</p>
<ul>
<li><a href="../git-add-cached">git add-cached</a></li>
<li><a href="../git-add-deleted">git add-deleted</a></li>
<li><a href="../git-add-others">git add-others</a> (this alias)</li>
