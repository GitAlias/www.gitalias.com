<svelte:head>
    <title>git add-killed | GitAlias.com</title>
</svelte:head>

<div class="prose">

<h1 id="git-add-killed">git add-killed</h1>
<h2 id="add-killed-files">Add killed files</h2>
<p>Git alias:</p>
<pre class="git"><code>add-killed = !&quot;f() &lbrace; git ls-files --killed | sort -u ; &rbrace;; git add `grave;f`grave;&quot;</code></pre>
<p>Example:</p>
<pre class="shell"><code>git add-killed</code></pre>
<p>Compare:</p>
<ul>
...
<li><a href="../git-add-killed">git add-killed</a> (this alias)</li>
