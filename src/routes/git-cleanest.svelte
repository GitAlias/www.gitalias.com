<svelte:head>
    <title>git cleanest | GitAlias.com</title>
</svelte:head>

<div class="prose">

<h1 id="git-cleanest">git cleanest</h1>
<h2 id="clean-a-working-tree-using-the-most-powerful-options">Clean a
working tree using the most powerful options</h2>
<p>Git alias:</p>
<pre class="git"><code>cleanest = clean -dffx</code></pre>
<p>Example:</p>
<pre class="shell"><code>git cleanest</code></pre>
<p>This will remove untracked files from the working tree.</p>
<h3 id="documentation-of-git-clean-flags">Documentation of
<code>git clean</code> flags</h3>
<dl>
<dt>
-d
</dt>
